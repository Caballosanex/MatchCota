...
// Public Pages
import Landing from './pages/platform/Landing'; // Import Landing
import Home from './pages/public/Home'; // Still keeping Home imported just in case, or maybe it should be tenant home
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            {/* Landing Route - No Layout (Landing has its own Header/Footer) */}
